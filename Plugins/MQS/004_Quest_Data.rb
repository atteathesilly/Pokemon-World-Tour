module QuestModule
  ...
  QUEST_HIDE_AND_SEEK = {
    ...
    :QuestDescription => _INTL("Play hide and seek with that kid. I guess you aren't too old for this stuff yet huh?"),
  ...
  QUEST_DIGIT_SLIPS = {
    ...
    :QuestDescription => _INTL("The local ranger is tired of Rafael's gym puzzle. Sounds like they got a reward for whoever brings them all to them."),
  }
  ...
  QUEST_MEMORY_LANE = {
    ...
    :Location1 => _INTL("County Park"),
    :QuestDescription => _INTL("This former Team Chasm member has been feeling nostalgic. Show them a Bergmite, a Klink, a Dreepy, a Makyan Tangela, and an Elekid so they can reminisce about the old days."),
