    ...
    def pbStartBattleSendOut(sendOuts)
        ...
        if wildBattle?
            ...
            when 1
                ...
                if bossBattle?
                    pbDisplayPaused(_INTL("Oh no! The boss {1} appeared!", foeName))
                else
                    pbDisplayPaused(_INTL("Oh! A wild {1} appeared!", foeName))
                end
            when 2
                if bossBattle?
                    pbDisplayPaused(_INTL("Oh no! The boss {1} and {2} appeared!", foeParty[0].name,
                        foeParty[1].name))
                else
            ...
            when 3
                if bossBattle?
                    pbDisplayPaused(_INTL("Oh no! The boss {1}, {2} and {3} appeared!", foeParty[0].name,
